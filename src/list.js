...
// //             <textarea type="text" name="list_name" class="block float-left w-10/12 p-3" id="list-name" placeholder="Enter List Name"><br>
// //         </div>
// //     </form><br></br>
// //     `
// //     const itemForm =
...
// //           <form action="index.html" method="post">
            //<label for="content">Enter your items: </label><br>
            //<textarea type="text" name="item_content" class="block float-left w-10/12 p-3" id="item" placeholder="Enter Item Information"></textarea><br>
